       ...
       if($count > 0)
        {
            if ($isadmin == "1")
             ...
             else if($active == 'active')
             {
                ...
                echo 'You listed as inactive please contact administrator';
                exit();
             }
        }
             else
...
?>
    ...
    <head>
        ...
        <title>Moon Residents - Login Page</title>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-dark my-4">Welcome to Moon Apartment Management Systems</h3></div>
                                    <div class="card-body">
